/-
  ...
  Purpose:
  Downstream strip-threaded modules should import this file to obtain the
  coordinate vanishings bundle as a theorem, without ever touching the global
  nondegeneracy axiom `a0_ne_zero`.

  This file is intentionally tiny: it re-exports the extractor-side theorem
  under a stable name `xiAtOrderCoords01Out_fromAnalytic_strip`.
-/

...
theorem row0Sigma_w0_eq_zero_fromRec2 (s : OffSeed Xi) :
...
theorem row0Sigma_wp2_eq_zero_fromRec2 (s : OffSeed Xi) :
...
theorem row0Sigma_wp3_eq_zero_fromRec2 (s : OffSeed Xi) :
